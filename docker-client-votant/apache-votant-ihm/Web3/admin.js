...
/** V2
var createSetUpTextBoxCreated = false;
function createSetUpTextBox() {
	if (!createSetUpTextBoxCreated) {
		createSetUpTextBoxCreated = true;
		document.getElementById('title').innerHTML = "Set up of the election";
	    document.getElementById('question').setAttribute("hidden", true);
...
function finishSetUp() {
    ...
    document.getElementById('title').innerHTML = "The Election Time Table";
    document.getElementById('section_desc').innerHTML = "";
    //V2 document.getElementById('setup').setAttribute("hidden", true);
    document.getElementById('listoftimers').removeAttribute("hidden");
}
