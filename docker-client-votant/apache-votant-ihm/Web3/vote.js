    ...
    function currentState() {
        ...
        if (state == 0) {
          ...
          if(anonymousvotingAddr.votecast(addr)) {
            ...
            if (!checkedCommit && addressChosen && uploaded) {
