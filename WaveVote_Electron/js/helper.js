...
function initContracts() {
	...
	var WaveVoteContractRegistryAddr = WaveVoteContractRegistry.at("0xe73B1eBf7190A66e2b07F39A8cF9A117Db4d2740");
...
function initWaveVoteContract(WaveVoteContractRegistryAddr) {
	try {
		// Anonymous Voting Contract
		var abiWaveVote = JSON.parse(WaveVoteContractRegistryAddr.lastWaveVoteAbi());
		...
		//var WaveVoteAddr = WaveVote.at("0x56800c550c8B63dE33734370E081151aBe9cFb33");
		if(WaveVoteAddr.owner()==="0x"){
			//alert("Contract no found ! Please contact an administrator");
